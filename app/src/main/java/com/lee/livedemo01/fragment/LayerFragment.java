...
import com.lee.livedemo01.adapter.AudienceAdapter;
import com.lee.livedemo01.adapter.MessageAdapter;
import com.lee.livedemo01.dmutils.DanmakuEntity;
import com.lee.livedemo01.tools.DanMuHelper;
import com.lee.livedemo01.tools.DisplayUtil;
import com.lee.livedemo01.tools.GiftAnmManager;
import com.lee.livedemo01.tools.SoftKeyBoardListener;
import com.lee.livedemo01.view.CustomRoundView;
import com.lee.livedemo01.view.DivergeView;
import com.lee.livedemo01.view.HorizontalListView;
import com.lee.livedemo01.view.MagicTextView;
...
public class LayerFragment extends Fragment implements View.OnClickListener {
    ...
    private TextView tvSendfive;
    private TextView tvSendsix;
    private TextView tvSendseven, sendDM;
    ...
    private BSRGiftView imageButton;
    ...
    public void initView(View view){
        ...
        tvSendfive = (TextView) view.findViewById(R.id.tvSendfive);
        tvSendsix = (TextView) view.findViewById(R.id.tvSendsix);
        tvSendseven = (TextView) view.findViewById(R.id.tvSendseven);
        sendDM = (TextView) view.findViewById(R.id.sendDM);
        ...
        imageButton = (BSRGiftView) view.findViewById(R.id.gift_view);
        ...
        tvSendfive.setOnClickListener(this);
        tvSendsix.setOnClickListener(this);
        tvSendseven.setOnClickListener(this);
        sendInput.setOnClickListener(this);
        sendDM.setOnClickListener(this);
        giftAnmManager = new GiftAnmManager(giftLayout, getActivity());
        showDM(view);
     ...
     * 弹幕
     */
    public void showDM(View view){
        mDanMuHelper = new DanMuHelper(getActivity());

        // 全站弹幕（广播）
        mDanMuContainerBroadcast = (DanMuView) view.findViewById(R.id.danmaku_container_broadcast);
        mDanMuContainerBroadcast.prepare();
        mDanMuHelper.add(mDanMuContainerBroadcast);

        // 当前房间内的弹幕
        mDanMuContainerRoom = (DanMuView) view.findViewById(R.id.danmaku_container_room);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.tvSendfor:/*礼物4*/
                showGift("Johnny4");
                break;
            case R.id.tvSendfive:/*礼物5*/
                showGift("Johnny1");
                break;
            case R.id.tvSendsix:/*礼物5*/
                showBSTGift();
                break;
            case R.id.tvSendseven:/*礼物5*/
                showDm("万水千山总是情,给点鱼丸行不行~~");
                break;
            case R.id.sendDM:/*礼物5*/
                showDm(etInput.getText().toString().trim());
                break;
        }
    }
